...
public class CreateEventRequest
{
     ...
     * falls back to SeatingLayoutType.StraightRows when this is omitted.
     * When a value IS supplied, EnumDataType still rejects anything that
     * isn't a defined SeatingLayoutType member.
     */
